          ...
          <div className="lg:col-span-5 flex flex-col justify-between" id="footer-alamat">
            <div>
              ...
              <p className="text-stone-400 text-sm leading-relaxed mb-4">
                Distributor produk olahan frozen food seperti sosis, nugget, cedea, dan bakso yang berkualitas dengan harga terjangkau. Kamu bisa kunjungi alamat toko kami di bawah ini.
              </p>
              <a
          ...
          <div className="lg:col-span-4" id="footer-kontak">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <span className="block text-[10px] uppercase font-bold tracking-wider text-stone-500">Jam Operasional</span>
